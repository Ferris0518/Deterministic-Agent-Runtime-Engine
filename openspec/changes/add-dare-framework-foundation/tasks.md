...
- [x] 1.1 Scaffold `agent_framework/` package layout and define core data models (Task, Milestone, RunContext, Envelope, DonePredicate, Plan, ValidatedPlan, ToolResult, RunResult, PolicyDecision, RuntimeState).
