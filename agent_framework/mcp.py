...
from .interfaces import IMCPClient, ITool
from .models import ToolDefinition, ToolResult, ToolRiskLevel
...
class MCPTool:
    ...
    async def execute(self, input: dict, context) -> ToolResult:
        return await self._client.call_tool(self._definition.name, input)
