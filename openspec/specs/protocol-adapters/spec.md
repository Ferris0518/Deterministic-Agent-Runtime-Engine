...
## Purpose
TBD - created by archiving change refactor-kernel-architecture-v2. Update Purpose after archive.
## Requirements
### Requirement: Protocol Adapter Contract (v2)
...
### Requirement: MCP Adapter Integration Path (v2)
